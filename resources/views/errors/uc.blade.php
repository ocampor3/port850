...
<body>
    ...
    <div class="error-container">
        <div class="error-page">
            <h2 class="headline"> <i class="fa fa-warning text-danger"></i></h2>

            <div class="error-content">
                <h3>UNDER CONSTRUCTION.</h3>

                <p>
                    The page you're looking for is under construction.<br>
                    Meanwhile, you may <a href="{{url('/v1/')}}">return to the main page</a>.
                </p>
            </div>
        </div>
    </div>
